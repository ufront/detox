...
var SelectorEngineExample = function() { }
SelectorEngineExample.main = function() {
	var message;
	dtx.Tools.includeSizzle();
	message = "Including Sizzle as a fallback selector engine, will work in IE6, 7, 8 or modern browsers.";
	dtx.Tools.ready(function() {
		dtx.collection.ElementManipulation.setText(dtx.Tools.find("p.message"),message);
	});
}
var dtx = {}
