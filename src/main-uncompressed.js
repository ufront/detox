...
test.Main.run = function(e) {
	...
	haxe.Log.trace(domtools.QueryElementManipulation.attr(h1Node,"id"),{ fileName : "Main.hx", lineNumber : 28, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.text(domtools.QueryElementManipulation.setText(h1Node,"New Title")),{ fileName : "Main.hx", lineNumber : 29, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.text(textContentTest),{ fileName : "Main.hx", lineNumber : 30, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.text(domtools.QueryElementManipulation.setText(textContentTest,"Simplified")),{ fileName : "Main.hx", lineNumber : 31, className : "test.Main", methodName : "run"});
	...
	haxe.Log.trace(domtools.QueryElementManipulation.attr(h1Node,"class"),{ fileName : "Main.hx", lineNumber : 37, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.hasClass(h1Node,"big"),{ fileName : "Main.hx", lineNumber : 39, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.hasClass(h1Node,"massive"),{ fileName : "Main.hx", lineNumber : 40, className : "test.Main", methodName : "run"});
	...
	haxe.Log.trace(domtools.QueryElementManipulation.attr(h1Node,"class"),{ fileName : "Main.hx", lineNumber : 45, className : "test.Main", methodName : "run"});
	domtools.QueryElementManipulation.removeAttr(h1Node,"class");
	...
	haxe.Log.trace(domtools.QueryElementManipulation.attr(h1Node,"class"),{ fileName : "Main.hx", lineNumber : 51, className : "test.Main", methodName : "run"});
	...
	domtools.QueryElementManipulation.toggleClass(h1Node,"toggle-on");
	haxe.Log.trace(domtools.QueryElementManipulation.attr(h1Node,"class"),{ fileName : "Main.hx", lineNumber : 60, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.val(hiddenField),{ fileName : "Main.hx", lineNumber : 62, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.innerHTML(innerHTMLTest),{ fileName : "Main.hx", lineNumber : 64, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.innerHTML(domtools.QueryTraversing.firstChildren(innerHTMLTest)),{ fileName : "Main.hx", lineNumber : 65, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryTraversing.firstChildren(domtools.QueryElementManipulation.setInnerHTML(innerHTMLTest,"Welcome to the <strong>WORLD</strong> of tomorrow")).collection[0].nodeType,{ fileName : "Main.hx", lineNumber : 66, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.innerHTML(domtools.QueryTraversing.firstChildren(innerHTMLTest)),{ fileName : "Main.hx", lineNumber : 67, className : "test.Main", methodName : "run"});
	...
	haxe.Log.trace(new domtools.Query("#secondTitle") != null,{ fileName : "Main.hx", lineNumber : 72, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.text(h1Node.clone()),{ fileName : "Main.hx", lineNumber : 73, className : "test.Main", methodName : "run"});
	var allListItems = new domtools.Query("li");
	haxe.Log.trace(domtools.QueryElementManipulation.text(new domtools.Query(null,allListItems.collection[0])),{ fileName : "Main.hx", lineNumber : 76, className : "test.Main", methodName : "run"});
	haxe.Log.trace(allListItems.collection.length,{ fileName : "Main.hx", lineNumber : 77, className : "test.Main", methodName : "run"});
	var i = 0;
	...
	haxe.Log.trace(i == allListItems.collection.length,{ fileName : "Main.hx", lineNumber : 80, className : "test.Main", methodName : "run"});
	haxe.Log.trace(new domtools.Query(null,allListItems.collection[allListItems.collection.length - 1]).collection[0].textContent,{ fileName : "Main.hx", lineNumber : 81, className : "test.Main", methodName : "run"});
	...
	haxe.Log.trace(domtools.QueryElementManipulation.text(secondListItemInSecondList),{ fileName : "Main.hx", lineNumber : 91, className : "test.Main", methodName : "run"});
	...
	haxe.Log.trace(listItemsWithLetterI.collection.length,{ fileName : "Main.hx", lineNumber : 96, className : "test.Main", methodName : "run"});
	var $it1 = domtools.QueryTraversing.ancestors(secondListItemInSecondList).collection.iterator();
	while( $it1.hasNext() ) {
		var node = $it1.next();
		haxe.Log.trace(node.nodeName,{ fileName : "Main.hx", lineNumber : 100, className : "test.Main", methodName : "run"});
	}
	haxe.Log.trace(domtools.QueryTraversing.ancestors(secondListItemInSecondList).collection.length,{ fileName : "Main.hx", lineNumber : 102, className : "test.Main", methodName : "run"});
	haxe.Log.trace(domtools.QueryElementManipulation.text(domtools.QueryElementManipulation.addClass(domtools.QueryTraversing.find(new domtools.Query("ul"),"li.first"),"first-list-item")),{ fileName : "Main.hx", lineNumber : 104, className : "test.Main", methodName : "run"});
	var table = new test.Table();
	haxe.Log.trace(domtools.QueryElementManipulation.text(table),{ fileName : "Main.hx", lineNumber : 107, className : "test.Main", methodName : "run"});
	...
	domtools.QueryEventManagement.on(table,"click",function(e1) {
		...
		haxe.Log.trace(table1.nodeName.toLowerCase(),{ fileName : "Main.hx", lineNumber : 115, className : "test.Main", methodName : "run"});
		haxe.Log.trace(clickedNode.nodeName.toLowerCase() + ": " + clickedNode.textContent,{ fileName : "Main.hx", lineNumber : 116, className : "test.Main", methodName : "run"});
	});
	domtools.QueryEventManagement.one(new domtools.Query("#secondTitle"),"click",function(e1) {
		haxe.Log.trace("You got me! Never again...",{ fileName : "Main.hx", lineNumber : 120, className : "test.Main", methodName : "run"});
	});
	...
	}).collection.length,{ fileName : "Main.hx", lineNumber : 123, className : "test.Main", methodName : "run"});
}
test.Main.prototype = {
	__class__: test.Main
}
...
domtools.Traversing.firstChildren = function(node,elementsOnly) {
	...
	if(node.isElement()) {
		...
		while(elementsOnly == true && e != null && e.isElement() == false) e = e.nextSibling;
...
domtools.Query.prototype = {
	...
	,addNodeList: function(nodeList,elementsOnly) {
		...
		while(_g1 < _g) {
			...
			if(elementsOnly == false || node.isElement()) {
				this.collection.push(node);
				this;
			}
		}
