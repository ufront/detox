...
ToolsTest.prototype.findByElementSingle = function() {
	...
	massive.munit.Assert.areEqual(text,"Simple H1",{ fileName : "ToolsTest.hx", lineNumber : 59, className : "ToolsTest", methodName : "findByElementSingle"});
}
ToolsTest.prototype.findByElementMultiple = function() {
	var length = domtools.Traversing.find(this.body,"p").collection.length;
	massive.munit.Assert.areEqual(length,3,{ fileName : "ToolsTest.hx", lineNumber : 65, className : "ToolsTest", methodName : "findByElementMultiple"});
}
ToolsTest.prototype.readAttribute = function() {
	massive.munit.Assert.isTrue(false,{ fileName : "ToolsTest.hx", lineNumber : 70, className : "ToolsTest", methodName : "readAttribute"});
}
ToolsTest.prototype.writeAttribute = function() {
	massive.munit.Assert.isTrue(true,{ fileName : "ToolsTest.hx", lineNumber : 75, className : "ToolsTest", methodName : "writeAttribute"});
}
