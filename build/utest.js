...
UTest.prototype.__class__ = UTest;
List = function(p) {
	if( p === $_ ) return;
	this.length = 0;
}
...
ToolsTest.prototype.setup = function() {
	...
	domtools.ElementManipulation.setInnerHTML(this.body,str);
	haxe.Log.trace("Setup",{ fileName : "ToolsTest.hx", lineNumber : 32, className : "ToolsTest", methodName : "setup"});
}
ToolsTest.prototype.teardown = function() {
	this.body = null;
}
ToolsTest.prototype.findByElementSingle = function() {
	haxe.Log.trace("Setup",{ fileName : "ToolsTest.hx", lineNumber : 42, className : "ToolsTest", methodName : "findByElementSingle"});
	var text = domtools.QueryElementManipulation.text(domtools.Traversing.find(this.body,"H1"));
	utest.Assert.equals(text,"Simple H1",null,{ fileName : "ToolsTest.hx", lineNumber : 44, className : "ToolsTest", methodName : "findByElementSingle"});
}
ToolsTest.prototype.findByElementMultiple = function() {
	var length = domtools.Traversing.find(this.body,"p").collection.length;
	utest.Assert.equals(length,3,null,{ fileName : "ToolsTest.hx", lineNumber : 50, className : "ToolsTest", methodName : "findByElementMultiple"});
}
ToolsTest.prototype.readAttribute = function() {
	utest.Assert.isTrue(false,null,{ fileName : "ToolsTest.hx", lineNumber : 55, className : "ToolsTest", methodName : "readAttribute"});
}
ToolsTest.prototype.writeAttribute = function() {
	utest.Assert.isTrue(true,null,{ fileName : "ToolsTest.hx", lineNumber : 60, className : "ToolsTest", methodName : "writeAttribute"});
}
