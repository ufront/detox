...
domtools.Traversing.children = function(node,elementsOnly) {
	...
	if(node.isElement()) children.addNodeList(node.childNodes,elementsOnly);
	return children;
}
...
domtools.Traversing.lastChildren = function(node,elementsOnly) {
	...
	if(node.isElement()) {
		...
		while(elementsOnly == true && e != null && e.isElement() == false) e = e.previousSibling;
...
ToolsTest = function(p) {
}
ToolsTest.__name__ = ["ToolsTest"];
ToolsTest.prototype.templateNode = null;
ToolsTest.prototype.body = null;
ToolsTest.prototype.beforeClass = function() {
	this.templateNode = document.createElement("div");
	var str = "\n<h1>Simple H1</h1>\n<h2>Simple H2</h2>\n<h3>Simple H3</h3>\n<p class='type1'>Type 1</p>\n<p class='type2'>Type 2</p>\n<p class='type3'>Type 3</p>\n\n";
	domtools.ElementManipulation.setInnerHTML(this.templateNode,str);
}
ToolsTest.prototype.afterClass = function() {
}
ToolsTest.prototype.setup = function() {
	this.body = this.templateNode.cloneNode(true);
}
ToolsTest.prototype.tearDown = function() {
}
ToolsTest.prototype.findByElementSingle = function() {
	var text = domtools.QueryElementManipulation.text(domtools.Traversing.find(this.body,"H1"));
	massive.munit.Assert.areEqual(text,"Simple H1",{ fileName : "ToolsTest.hx", lineNumber : 58, className : "ToolsTest", methodName : "findByElementSingle"});
}
ToolsTest.prototype.findByElementMultiple = function() {
	var length = domtools.Traversing.find(this.body,"p").collection.length;
	massive.munit.Assert.areEqual(length,3,{ fileName : "ToolsTest.hx", lineNumber : 64, className : "ToolsTest", methodName : "findByElementMultiple"});
}
ToolsTest.prototype.readAttribute = function() {
	massive.munit.Assert.isTrue(false,{ fileName : "ToolsTest.hx", lineNumber : 69, className : "ToolsTest", methodName : "readAttribute"});
}
ToolsTest.prototype.writeAttribute = function() {
	massive.munit.Assert.isTrue(true,{ fileName : "ToolsTest.hx", lineNumber : 74, className : "ToolsTest", methodName : "writeAttribute"});
}
ToolsTest.prototype.__class__ = ToolsTest;
js.Lib = function() { }
...
ToolsTest.__meta__ = { fields : { beforeClass : { BeforeClass : null}, afterClass : { AfterClass : null}, setup : { Before : null}, tearDown : { After : null}, findByElementSingle : { Test : null}, findByElementMultiple : { Test : null}, readAttribute : { Test : null}, writeAttribute : { Test : null}}};
js.Lib.onerror = null;
TestMain.main()